package com.johan.project.mathoperationservice.aop;
...
public class LoggingAspect {
  ...
  @Before("execution(* com.johan.project.mathoperationservice..*.*(..)) && !@target(com.johan.project.mathoperationservice.aop.NoLogging)")
